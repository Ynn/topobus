...
TopoBus is a small KNX project viewer for ETS `.knxproj` files. It helps you quickly see the topology and group addresses of a KNX installation in a graphical way.
